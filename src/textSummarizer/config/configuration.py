...
from textSummarizer.enitity import (data_ingestion_config,PreprocessingConfig,ModelTrainerConfig,ModelEvalConfig)
...
class configuration_manager:
    ...
    def get_evaluation_config(self) -> ModelEvalConfig:
